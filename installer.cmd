...
echo[
powershell -NoProfile -ExecutionPolicy Bypass -NoLogo -File ./installer/scoop-installer.ps1
echo[
...
call :colorEcho 0A "All programs downloaded"
echo[
...
:python
	...
	echo[
	echo Download Latest python version manually at https://www.python.org/downloads/ and make sure you add to PATH: https://i.imgur.com/KXgMcOK.png
    goto :eof
:git
	TITLE Error!
	call :colorEcho 04 "git not added to PATH or not installed"
	echo[
	echo download git manually at https://git-scm.com/
    goto :eof
:ffmpeg
	TITLE Warning!
	call :colorEcho 04 "ffmpeg not added to PATH or not installed"
	echo[
	echo Download a ffmpeg version manually at https://ffmpeg.org/download.html#build-windows and make sure you add to PATH
    goto :eof
:mpv
	TITLE Error!
	call :colorEcho 04 "mpv not installed or not added to path"
    echo[
    echo Download mpv manually at https://mpv.io/installation/
    goto :eof
